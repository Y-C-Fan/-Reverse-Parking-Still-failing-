...
import { RotateCcw, MessageSquare, Info, Car, Sliders, Eye, Map } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [aiAdvice, setAiAdvice] = useState<string>("你好！我是你的老司机教练。挂入倒挡 (R)，轻踩油门开始倒车入库！");
